...
| JSP-000517 | [If a graph has no clique or independent set larger than logarithmic size, must it have many induced subgraphs with distinct pairs of vertex and edge counts?](catalog-0501-0600.md#JSP-000517) | Solved | Reported; source located | Pending verification | Unavailable |
